...
namespace Forms.Controls
{
    public class RoundButton : Button
    {
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            this.Parent.BackColorChanged += new EventHandler(Cointainer_BackColorChanged);

        }

        private void Cointainer_BackColorChanged(object sender, EventArgs e)
        {
            if (this.DesignMode)
                this.Invalidate();
        }
